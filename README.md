# ✈️📊 Flight Data Analysis — Python and R Project
...
• Performing R-based exploratory and statistical analysis for prices and duration correlation through data transformation and interpreting coefficients for scatter plot visualization.

## Dataset & Notebook
- Source notebook: `Flight_Data_Analysis_Python_Project.ipynb`
- Raw CSV expected: `airlines_flights_data.csv`
- R file: `Statistics_R_File.R` 
...
- Booking lead-time affects fares: As the number of days to departure decreases below 10-15 days, fare prices increase substantially.
...
## Files of interest 📁
- Flight_Data_Analysis_Python_Project.ipynb — primary analysis and charts with Python
- airlines_flights_data.csv — raw dataset (not tracked in repo; obtain from the original Kaggle source)
- Statistics_R_File.R — data transformation and scatter plot with R
